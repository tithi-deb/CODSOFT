...
public class StudentCourseRegistrationSystem {
    ...
    public static void main(String[] args) {
        ...
        Course course2 = new Course("MATH201", "Calculus I", "Fundamental calculus concepts", 25, List.of("Tue, Thu 2:00 PM"));
        Course course3 = new Course("ENG101", "English Composition", "Writing skills development", 20, List.of("Tue, Thu 10:00 AM"));
